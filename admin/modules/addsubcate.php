...
if (isset($_POST["addnew"])) {
    ...
    $sqlInsert = "INSERT INTO `subcategory`(`SubName`, `CategoryID`, `Status`) VALUES ('$subname',$id,$status)";
                ...
                <div class="card-body">
                    <form action="" method="post" id="basicform" data-parsley-validate="">
                        <div class="form-group">
                            <label for="SubName">Tên danh mục</label>
                            <input id="SubName"  type="text" name="SubName"  placeholder="Nhập tên danh mục" class="form-control">
                        </div>
